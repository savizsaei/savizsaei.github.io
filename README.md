...
- Programming/ Tools: Python, PySpark, SQL, RStudio, scikit-learn, LangChain, TensorFlow, PyTorch, Gurobi, JavaScript, React.

- Machine Learning Libraries: Optimization in Transportation, Two-Stage Stochastic Programming with Risk-Neutral, Risk-Averse, and Hybrid Approaches, System Resiliency, GenAI Modeling, Supervised/Unsupervised Learning, Reinforcement Learning, Gradient-Based Optimization, Statistical Analysis, Time Series Analysis.

- Cloud Computing: Azure, cloud deployment, APIs, Docker, Git, Power BI.
...
- Conducted regression analysis and data preprocessing using Python and SQL in collaboration with IBM, optimizing data quality and modeling to enhance predictive insights into human trafficking patterns.

### Project Mng & Data Scientist @Golrang System Company- IT (Jul 2017 – Nov 2020)
- Managed multiple projects using Azure DevOps; task management, and team collaboration to improve project efficiency and delivery timelines by 25%.
- Optimized sale process performance using SQL, Power BI, and Azure to increase sales by 15%.

### Project Mng & Sr. Data Analyst @Mobile Telecommunication (MCI) (May 2014 – Jun 2017)
...
4.	Saei, S., Tavakoli-Moghaddam, R., & Alinaghian, M. (2013). “A New Mathematical Model for a Multi-Depot Vehicle Routing Problem in a Natural Disaster Situation and Its Solution Using a Particle Swarm Optimization Algorithm.” Journal of Transportation Research, 12(142), 37-51.
5.	Saei, S., Najafi, E. (2013). “A new expansion on multi-stage DEA methodology in supply chain management”, Industrial Management (Sanandaj) ٫Number 25.
6.	Saei, S., Wang, Y., Marufuzzaman, M., Tajik, N., & Wang, H. (2022). “Prediction of Community Transmission Levels of COVID-19 Using Machine Learning Algorithms Based on the CDC Social Vulnerability Index.” Biomedical Sciences Instrumentation, 58(3), 9. International Academic Express (IAE).
Under Review:
...
## About
- 5+ years of experience in machine learning, statistical modeling, and optimization. Proficient in Python, Azure, and TensorFlow, with extensive experience deploying ML models in cloud environments. Proven ability to lead interdisciplinary teams and drive impactful solutions. U.S. Permanent Resident.
## Contact Information
- **Mobile:** +1-740-818-8877
- **Email:** [saviz.saei@gmail.com](mailto:saviz.saei@gmail.com)
- **LinkedIn:** [Saviz Saei](https://www.linkedin.com/in/saviz-saei-61141943/)
